...
Addon jars should compile against the published `io.github.louguerrier22:mayorsystem-api:<version>` package, or the local `MayorSystem-<version>-api.jar` while testing. At runtime, addons load the live API from Bukkit `ServicesManager`.
